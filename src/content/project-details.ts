...
export type ProjectDetail = {
  ...
  /**
   * Screenshots of what the project actually produced. Optional, because most of
   * these projects are pipelines whose output is a table rather than a screen.
   */
  figures?: Figure[];
...
export const projectDetails: Record<string, ProjectDetail> = {
  ...
  "imdb-analytics": {
    ...
    figures: [
      {
        src: "/projects/figures/imdb-dashboard-catalogue-overview.webp",
        width: 2000,
        height: 1208,
        tone: "light",
        alt: "Tableau dashboard for the IMDb warehouse showing KPI tiles for titles, movies, TV series, average rating, average runtime, regions and languages, above a dual line chart of releases per year split by movie and TV, tables of the top regions and languages by title count, a genre distribution bar chart, top rated titles, and an adult versus non-adult comparison.",
        caption:
          "Catalogue overview, reading from six of the ten gold tables. The release curve splits movie against TV, and the region and language tables come from fact_regional_release joined to the two ISO dimensions.",
      },
      {
        src: "/projects/figures/imdb-dashboard-television-and-people.webp",
        width: 2000,
        height: 1208,
        tone: "light",
        alt: "Second Tableau dashboard covering television and people, with KPI tiles for titles, movies, TV series, unique seasons, unique episodes, average runtime and average TV rating, above top rated movies and top rated TV series bar charts, a season by season ratings breakdown, a world map of regional releases, and credits counted by profession.",
        caption:
          "Television, people and geography. The season breakdown runs off dim_episode, the map off fact_regional_release, and the profession counts off bridge_person_profession, the bridge that made normalising the crew table worth doing.",
      },
    ],
    sourceNote:
  ...
  "nvidia-fin-rag": {
    ...
    results: [
      ...
      {
        metric: "85 to 92%",
        label: "Retrieval relevance across three chunking strategies",
      },
    ...
    links: [
      { label: "Live app", href: "https://nvidia-finrag.streamlit.app/" },
    ],
  },
  ...
  "financial-report-agent": {
    ...
    results: [
      ...
      {
        metric: "12",
        label: "Quarters indexed per company, 2023 through 2025",
      },
      {
        metric: "3",
        label: "Sources reconciled: filings, market data, and news",
      },
      {
        metric: "5",
        label: "API endpoints, with every tool testable on its own",
      },
    ],
    diagram: {
      caption:
  ...
  "mental-wellness-rl": {
    ...
    results: [
      ...
      {
        metric: "79%",
        label: "Engagement rate, a 75% improvement on the baseline",
      },
      {
        metric: "19",
    ...
    results: [
      {
        metric: "3",
        label:
          "Parameterised datasets serving all 9 pipelines and 7 data flows",
      },
      {
        metric: "8",
        label: "Conformed dimensions feeding one sales fact table",
      },
      {
        metric: "11",
        label: "Source tables extracted by a single Copy activity",
      },
      {
        metric: "24",
        label: "Factory resources deployed from one ARM template",
      },
    ],
    diagram: {
      caption:
    ...
    results: [
      {
        metric: "3",
        label:
          "Dimension lookups with sentinel keys, so unmatched rows still land",
      },
      {
        metric: "13",
      ...
      },
      {
        metric: "2",
        label:
          "Public sources joined: the licence register and ZIP reference data",
      },
    ...
    diagram: {
      ...
      nodes: [
        ...
        },
        {
          ...
          row: 1,
          kind: "source",
          note: "state, county, city",
        },
        {
          id: "copy",
          label: "2 Copy activities",
          col: 1,
          row: 0,
          kind: "process",
  ...
  "fred-economic-data": {
    ...
    links: [
      { label: "Live app", href: "https://fredanalytics.streamlit.app/" },
    ],
  },
  ...
  "academic-research-assistant": {
    ...
    results: [
      {
        metric: "4",
        label: "Agents: coordinator, gatherer, analyst, synthesizer",
      },
